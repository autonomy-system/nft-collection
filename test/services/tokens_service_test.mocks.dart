...
// in nft_collection/test/services/tokens_service_test.dart.
...
class MockNftCollectionDatabase extends _i1.Mock
  ...
  _i2.AssetTokenDao get assetDao => (super.noSuchMethod(
        ...
        returnValue: _FakeAssetTokenDao_0(
          this,
          Invocation.getter(#assetDao),
        ),
      ) as _i2.AssetTokenDao);
  @override
  _i3.TokenOwnerDao get tokenOwnerDao => (super.noSuchMethod(
        Invocation.getter(#tokenOwnerDao),
        returnValue: _FakeTokenOwnerDao_1(
          this,
          Invocation.getter(#tokenOwnerDao),
        ),
      ) as _i3.TokenOwnerDao);
  @override
  _i4.ProvenanceDao get provenanceDao => (super.noSuchMethod(
        Invocation.getter(#provenanceDao),
        returnValue: _FakeProvenanceDao_2(
          this,
          Invocation.getter(#provenanceDao),
        ),
  ...
  @override
  _i5.Future<dynamic> removeAll() => (super.noSuchMethod(
        Invocation.method(
          #removeAll,
          [],
        ),
...
class MockNftCollectionPrefs extends _i1.Mock
  ...
  @override
  _i5.Future<DateTime?> getLatestRefreshTokens() => (super.noSuchMethod(
        Invocation.method(
          #getLatestRefreshTokens,
          [],
        ),
...
class MockIndexerApi extends _i1.Mock implements _i11.IndexerApi {
  ...
  @override
  _i5.Future<List<_i12.Asset>> getNFTTokens(int? offset) => (super.noSuchMethod(
        Invocation.method(
          #getNFTTokens,
          [offset],
        ),
  ...
  _i5.Future<_i7.BlockchainIdentity> getIdentity(String? accountNumber) =>
      (super.noSuchMethod(
        ...
        returnValue:
            _i5.Future<_i7.BlockchainIdentity>.value(_FakeBlockchainIdentity_5(
          this,
          Invocation.method(
            #getIdentity,
            [accountNumber],
...
class MockAssetTokenDao extends _i1.Mock implements _i2.AssetTokenDao {
  ...
  @override
  _i5.Future<List<_i13.AssetToken>> findAllAssetTokens() => (super.noSuchMethod(
        Invocation.method(
          #findAllAssetTokens,
          [],
        ),
  ...
  @override
  _i5.Future<List<String>> findAllAssetTokenIDs() => (super.noSuchMethod(
        Invocation.method(
          #findAllAssetTokenIDs,
          [],
        ),
        returnValue: _i5.Future<List<String>>.value(<String>[]),
      ) as _i5.Future<List<String>>);
  ...
  @override
  _i5.Future<List<String>> findAllAssetArtistIDs() => (super.noSuchMethod(
        Invocation.method(
          #findAllAssetArtistIDs,
          [],
        ),
        returnValue: _i5.Future<List<String>>.value(<String>[]),
      ) as _i5.Future<List<String>>);
  ...
  @override
  _i5.Future<void> removeAllExcludePending() => (super.noSuchMethod(
        Invocation.method(
          #removeAllExcludePending,
          [],
        ),
        returnValue: _i5.Future<void>.value(),
        returnValueForMissingStub: _i5.Future<void>.value(),
